...
public class CSRUtils {
    ...
    public static void checkBasicCSRInfo(CSR csr) throws CSRException {
        ...
        else if(csr.getCommonName().equals("") || csr.getCommonName() == null || csr.getCommonName().length() < 2) {
            throw new CSRException("Common name field must have at least 2 characters.");
        }
        ...
        else if(csr.getOrganization().equals("") || csr.getOrganization() == null || csr.getOrganization().length() < 2) {
            throw new CSRException("Organization field must have at least 2 characters.");
        }
        else if(csr.getCity().equals("") || csr.getCity() == null || csr.getCity().length() < 2) {
            throw new CSRException("City field must have at least 2 characters.");
        }
        else if(csr.getState().equals("") || csr.getState() == null || csr.getState().length() < 2) {
            throw new CSRException("State field must have at least 2 characters.");
        }
