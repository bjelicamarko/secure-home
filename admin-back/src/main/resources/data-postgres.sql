...
values('csr1@maildrop.cc', 'csr1name', 'csr1organization', 'csr1organizationunit', 'csr1city', 'csr1state', 'csr1country', '23i5yg23b5i23vA', true);

insert into csr (email, common_name, organization, organization_unit, city, state, country, security_code, verified)
values('csr2@maildrop.cc', 'csr2name', 'csr2organization', 'csr2organizationunit', 'csr2city', 'csr2state', 'csr2country', 'Aii5yg24b5i23yf', true);

insert into csr (email, common_name, organization, organization_unit, city, state, country, security_code, verified)
values('csr3@maildrop.cc', 'csr3name', 'csr3organization', 'csr3organizationunit', 'csr3city', 'csr3state', 'csr3country', '4uo5yg23b5i23vC', true);

insert into csr (email, common_name, organization, organization_unit, city, state, country, security_code, verified)
values('csr4@maildrop.cc', 'csr4name', 'csr4organization', 'csr4organizationunit', 'csr4city', 'csr4state', 'csr4country', '13i5yg23b5i73vA', false);

insert into csr (email, common_name, organization, organization_unit, city, state, country, security_code, verified)
values('csr5@maildrop.cc', 'csr5name', 'csr5organization', 'csr5organizationunit', 'csr5city', 'csr5state', 'csr5country', 'BBi5yg23b5i28vA', false);

insert into csr (email, common_name, organization, organization_unit, city, state, country, security_code, verified)
values('csr6@maildrop.cc', 'csr6name', 'csr6organization', 'csr6organizationunit', 'csr6city', 'csr6state', 'csr6country', 'hri5yu27b8928vy', false);