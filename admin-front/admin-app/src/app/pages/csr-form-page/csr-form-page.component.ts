...
export class CsrFormPageComponent {
  ...
  constructor(
    ...
    this.form = this.fb.group({
      commonName: ['', [Validators.required, BasicValidatorWithSpace, MinLengthValidator, MaxLengthValidator]],
      organization: ['', [Validators.required, BasicValidatorWithSpace, MinLengthValidator, MaxLengthValidator]],
      organizationUnit: ['', [Validators.required]],
      email: ['', [Validators.required, EmailValidator]],
      city: ['', [Validators.required, BasicValidatorWithSpace, MinLengthValidator, MaxLengthValidator]],
      state: ['', [Validators.required, BasicValidatorWithSpace, MinLengthValidator, MaxLengthValidator]],
